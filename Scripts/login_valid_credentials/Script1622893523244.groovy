...
WebUI.verifyElementVisible(findTestObject('Object Repository/Page_OrangeHRM/h1_Dashboard'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_OrangeHRM/a_Welcome Paul'))
